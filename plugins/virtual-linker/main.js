...
var PrefixTree = class {
  ...
  addFileToTree(file) {
    ...
    const tags = ((_a = (0, import_obsidian2.getAllTags)(this.app.metadataCache.getFileCache(file))) != null ? _a : []).filter((tag) => tag && tag.trim().length > 0).map((tag) => tag.startsWith("#") ? tag.slice(1) : tag);
